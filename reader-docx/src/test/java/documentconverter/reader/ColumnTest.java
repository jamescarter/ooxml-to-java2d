...
public class ColumnTest {
	...
	public void testAddContent() {
		column.addContent(10, 10, new DrawStringAction("Text", 0));
		column.addContent(90, 10, new DrawStringAction("Text", 0));
	}

	@Test(expected = ContentTooBigException.class)
	public void testContentTooBig() {
		column.addContent(101, 10, new DrawStringAction("Text", 0));
	}
